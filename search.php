...
$gal=mysqli_query($conn,"SELECT * FROM `product_info` INNER JOIN categories ON product_info.cId = categories.cId WHERE pQuantity > 0 AND (pName LIKE '%$query%' OR cName LIKE '%$query%') ");
